 ...
 */
public class DdAnimateIndicator extends LinearLayout {
    ...
    public DdAnimateIndicator(Context context) {
        super(context);
        init(context, null);
    }

    public DdAnimateIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mAnimatorResId = typedArray.getResourceId(R.styleable.DdIndicator_dd_animator,
                R.animator.scale_with_alpha);
        mAnimatorReverseResId =
                typedArray.getResourceId(R.styleable.DdIndicator_dd_animator_reverse, 0);
        mIndicatorBackgroundResId =
                typedArray.getResourceId(R.styleable.DdIndicator_dd_drawable,
                        R.drawable.white_radius);
        mIndicatorUnselectedBackgroundResId =
                typedArray.getResourceId(R.styleable.DdIndicator_dd_drawable_unselected,
                        mIndicatorBackgroundResId);
        typedArray.recycle();
    }
